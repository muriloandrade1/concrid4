                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <!--<a href="servicos.php" class="btn btn_">todos</a>  <a class="btn btn_" href="index.php">Sair</a>-->
        ...
        <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only"></span></button>
                        <p class="lead">Relatórios Técnicos, Laudos e Memoriais de Engenharia</p>
                    </div>
                    <div class="modal-body">
                        <div class="panel-body">
                            <p>Fazemos visitas e vistorias técnicas objetivando a elaboração de laudos e relatórios técnicos e fotográficos. Preparamos memoriais descritivos de projetos de engenharia para melhor entendimento e aplicabilidade de Normas Técnicas.</p>
