                ...
                <div class="span12">
                    <div class="header-block clearfix">
                        <div class="clearfix header-block-pad">
                            ...
                            <form id="search-form" action="search.php" method="GET" accept-charset="utf-8" class="navbar-form" id="FormName" action="search.php" method="post" name="FormName" onsubmit="return validate_form(this)">
                                <input class="dsR2" type="search" name="search" results="5" size="25" accesskey="S" type="text" name="s" onBlur="if (this.value == '')
