        ...
        <div class="span4">
            ...
            <ul class="thumbnails_2">
            	<li class="thumbnail_2">
                    ...
                    <p class="text-info">Usinas Hidrelétricas</p>
